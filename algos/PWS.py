# main class chaining Planner, Worker and Solver.test
import re
import time
...
class PWS:
    def __init__(self, available_tools=["Google", "LLM"], fewshot="\n", planner_model="gpt-4o",
        ...
        self.tool_token_unit_price = get_token_unit_price(solver_model)
    ...
    def run(self, input):
        ...
        for i in range(len(self.plans)):
            ...
            print("Evidence:",self.worker_evidences)
...
class PWS_Base(PWS):
    def __init__(self, fewshot=fewshots.HOTPOTQA_PWS_BASE, planner_model="gpt-4o",
                 solver_model="gpt-4", available_tools=["Wikipedia", "LLM"]):
...
class PWS_Extra(PWS):
    def  __init__(self, fewshot=fewshots.HOTPOTQA_PWS_EXTRA, planner_model="gpt-4o",
                 solver_model="gpt-4", available_tools=["Google", "Calculator", "LLM"]):
        super().__init__(available_tools=available_tools,
                         fewshot=fewshot,
                         planner_model=planner_model,
                         solver_model=solver_model)
